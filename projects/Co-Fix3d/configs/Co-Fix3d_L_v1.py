...
custom_hooks = [dict(type='DisableObjectSampleHook', disable_after_epoch=15)
                # dict(type='LoadMyCheckpointHook', load_img_from='/home/li/workspace/mmdet3d/cpt/dd3d_det_final.pth')
                ]
# load_from = '/home/li/workspace/mmdet3d/work_dirs/diffusionBEV_lidar_v1/3.30.9/epoch_20.pth'
