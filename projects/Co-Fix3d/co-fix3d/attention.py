...
class FlashMHA(nn.Module):
    ...
    def forward(self, q, k, v, key_padding_mask=None):
        ...
        with torch.autocast('cuda'):
            context, attn_weights = self.inner_attn(q.half(), kv.half(), key_padding_mask=key_padding_mask, causal=self.causal)
        return self.out_proj(rearrange(context.float(), 'b s h d -> b s (h d)')), attn_weights
...
class MultiheadFlashAttention(BaseModule):
    ...
    def __init__(self,
        ...
        self.attn = FlashMHA(embed_dims, num_heads, attn_drop, device='cuda', **kwargs)
