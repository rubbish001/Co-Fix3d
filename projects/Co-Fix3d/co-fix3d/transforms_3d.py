...
class ImageAug3D(BaseTransform):
    ...
    def __init__(self, ida_aug_conf=None, is_train=None):
        self.final_dim =ida_aug_conf["final_dim"]
        self.resize_lim = ida_aug_conf["resize_lim"]
        self.bot_pct_lim = ida_aug_conf["bot_pct_lim"]
        self.rand_flip = ida_aug_conf["rand_flip"]
        self.rot_lim = ida_aug_conf["rot_lim"]
